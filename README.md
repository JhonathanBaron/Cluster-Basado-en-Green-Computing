# Cluster-Basado-en-Green-Computing
Construcción y configuración de un clúster Beowulf utilizando hardware reutilizado para procesamiento de datos y computación paralela.
